    ...
    return (
      <>
       <div class="container-privacidade-termos">
        ...
        <p>A sua privacidade é importante para nós. É política do Protocolo Fórmula A.M.B respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Fórmula A.M.B, e outros sites que possuímos e operamos.</p>
        ...
        <h2>Política de Cookies Fórmula A.M.B</h2>
      ...
      <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Fórmula A.M.B oferece no site e com caráter enunciativo, mas não limitativo:</p>
      ...
      <p>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Fórmula A.M.B, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</p>
