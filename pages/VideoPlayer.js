...
function VideoPlayer() {
  ...
  useEffect(() => {
    ...
    script.src = 'https://scripts.converteai.net/1db8e03a-c1fc-4fa6-b094-4a5346a615e6/players/64637f661503a50008ca24b5/player.js';
    script.async = true;
  ...
  return (
    <div>
      <div id="vid_64637f661503a50008ca24b5" style={{ position: 'relative', width: '100%', padding: '56.25% 0 0' }}>
        <img
          id="thumb_64637f661503a50008ca24b5"
          src="https://images.converteai.net/1db8e03a-c1fc-4fa6-b094-4a5346a615e6/players/64637f661503a50008ca24b5/thumbnail.jpg"
          alt=""
          style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover', display: 'block' }}
        />
      <div
          id="backdrop_64637f661503a50008ca24b5"
